...
<div class="index-home" markdown>

<div class="index-hero" markdown>

<p class="index-hero__eyebrow">Security Operations Briefing</p>
...
<p class="index-hero__status"><span class="index-pulse" aria-hidden="true"></span> Live · <!--INDEX_DATE-->Sunday, August 2, 2026<!--/INDEX_DATE--></p>

</div>

<div class="grid cards index-grid" markdown>

-   ![Anthropic](2026/Week31/images/Anthropic.png){.index-card__img}
    ...
    **AI Safety Incident**{.cve-chip} **Evaluation Escape**{.cve-chip} **Sandbox Misconfiguration**{.cve-chip} **Autonomous Offensive Actions**{.cve-chip} **Supply Chain Risk**{.cve-chip}
    ...
    [Read more →](2026/Week31/Anthropic.md){.index-card__cta}

-   ![DeepSeek](2026/Week31/images/DeepSeek.png){.index-card__img}
    ...
    **AI-Enabled Offensive Ops**{.cve-chip} **DeepSeek**{.cve-chip} **Hermes Agent**{.cve-chip} **Telegram C2**{.cve-chip} **Automated Exploitation**{.cve-chip}
    ...
    [Read more →](2026/Week31/DeepSeek.md){.index-card__cta}

-   ![5G](2026/Week31/images/5G.png){.index-card__img}
    ...
    **Telecom Core Security**{.cve-chip} **4G LTE**{.cve-chip} **5G Core (5GC)**{.cve-chip} **Protocol Exploitation**{.cve-chip} **Service Disruption Risk**{.cve-chip}
    ...
    [Read more →](2026/Week31/5G.md){.index-card__cta}

-   ![Fuyao](2026/Week31/images/Fuyao.png){.index-card__img}
    ...
    **Supply-Chain Malware**{.cve-chip} **Android TV Boxes**{.cve-chip} **Ad Fraud**{.cve-chip} **SOCKS5 Proxy Abuse**{.cve-chip} **Residential IP Exploitation**{.cve-chip}
    ...
    [Read more →](2026/Week31/Fuyao.md){.index-card__cta}

-   ![OctLurk](2026/Week31/images/OctLurk.png){.index-card__img}
    ...
    **Cyber Espionage**{.cve-chip} **OctLurk/SilkLurk**{.cve-chip} **PlugX Activity**{.cve-chip} **Credential Theft**{.cve-chip} **Living-off-the-Land**{.cve-chip}
    ...
    [Read more →](2026/Week31/OctLurk.md){.index-card__cta}

-   ![Brinks](2026/Week31/images/Brinks.png){.index-card__img}
    ...
    **Data Extortion**{.cve-chip} **ShinyHunters**{.cve-chip} **Unauthorized Access**{.cve-chip} **Potential Data Exfiltration**{.cve-chip} **Smart Home Sector**{.cve-chip}
    ...
    [Read more →](2026/Week31/Brinks.md){.index-card__cta}

</div>

<footer class="index-footer" markdown>

<div class="index-footer__inner" markdown>

<p class="index-footer__label">published by EG-ETCS team on GitHub</p>


<nav class="index-footer__nav" markdown>

[Organization](https://github.com/EG-ETCS){.index-footer__link}
<span class="index-footer__sep" aria-hidden="true"></span>
[Incidents Repo](https://github.com/EG-ETCS/Incidents){.index-footer__link}
